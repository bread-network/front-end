const HomeBar = ({ title, svg }) => {
    return <div className="sticky top-0 z-10 bg-white p-2 flex flex-row justify-between items-center border border-gray-100">
        ...
        >
            {svg ? svg : <svg height="24" viewBox="0 0 24 24" className="fill-current">
                <g>
